...
public class UserServiceImpl implements UserService {
	...
	// TODO Implementare questi metodi, chiamando i metodi implementati in
	// UserDAOImpl
	@Override
	...
	public List<User> cercaTuttiQuelliCreatiPrimaDi(Date dataConfronto) throws Exception {
		...
		try (Connection connection = MyConnection.getConnection(Constants.DRIVER_NAME, Constants.CONNECTION_URL)) {
			...
			// eseguo quello che realmente devo fare
			result = userDao.findAllByDateCreatedBefore(dataConfronto);
	...
	public List<User> cercaPerCognomeENomeCheInziaCon(String cognomeInput, String inzialeNomeInput) throws Exception {
		...
		try (Connection connection = MyConnection.getConnection(Constants.DRIVER_NAME, Constants.CONNECTION_URL)) {
			...
			// eseguo quello che realmente devo fare
			result = userDao.findAllByCognomeAndNomeStartWith(cognomeInput, inzialeNomeInput);
